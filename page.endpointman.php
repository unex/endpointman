...
switch ($page) {
    case 'advanced':
        include LOCAL_PATH . 'includes/advanced.inc.php';
        break;
    case 'epm_oss':
        include LOCAL_PATH . 'includes/advanced.inc.php';
        break;
    ...
    case 'template_manager':
        include LOCAL_PATH . 'includes/template_manager.inc.php';
        break;
    ...
    case 'brand_model_manager':
        include LOCAL_PATH . 'includes/brand_model_manager.inc.php';
        break;

    case 'installer':
        include LOCAL_PATH . 'install.inc.php';
        break;
